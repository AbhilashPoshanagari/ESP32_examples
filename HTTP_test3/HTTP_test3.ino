      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta charset="UTF-8"><title>Website Design </title><link rel="icon" href="data:,">
            ...
            // Web Page Heading
            client.println("<body><h1>abhi.sree</h1></body>");
