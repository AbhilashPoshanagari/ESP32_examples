...
char pub_topic[] = "iot-2/evt/status/fmt/string";
char sub_topic[] = "iot-2/cmd/blink/fmt/string";
...
const char* mqtt_server = "yv3pgj.messaging.internetofthings.ibmcloud.com";
