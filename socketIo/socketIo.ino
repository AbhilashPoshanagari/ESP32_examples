...
#if USE_SSL
  #define WS_SERVER           "192.168.43.166"
  #define WS_PORT             4000
#else  
  #define WS_SERVER           "192.168.43.166"
  #define WS_PORT             4000
...
void setup()
{
  ...
  WiFiMulti.addAP("abhi.sreeJ7", "abhilash");
...
#else  
  webSocket.begin(WS_SERVER, WS_PORT, "/socket.io/?transport=websocket");
#endif
